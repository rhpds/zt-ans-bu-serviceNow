...
If you have encountered an issue or have noticed something not quite right, please link:https://github.com/ansible/workshops/issues/new?labels=ansibe-builder&title=Issue+with+Getting+started+with+ServiceNow-automation&assignees=abwalczyk[open an issue on GitHub].
